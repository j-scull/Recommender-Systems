...
public class Evaluator {
	...
	private RecAlg alg;           // non-personalised recommender algorithm
	 ...
	 * @numUsers - the number of users to use in the evaluation
	 */
	public Evaluator(final RecAlg alg, final DatasetReader reader, final int k, final Integer numUsers)	{
		this.alg = alg;
		this.reader = reader;
		this.k = k;
		this.seed = 1234;
	 ...
	 * @param reader - dataset reader
	 * @param k - the number of recommendations to be made
	 * @param numUsers - the number of users to use in the evaluation
	 * @param seed - a user defined random seed
	 */
	public Evaluator(final RecAlg alg, final DatasetReader reader, final int k,	final Integer numUsers, final int seed) {
		this.alg = alg;
		this.reader = reader;
		this.k = k;
		this.seed = seed;
	...
	/**
	 * Selects users from the data set to evaluate
	 * @param numUsers - the number of users to select
	 */
	...
	/**
	 * Evaluates the coverage of a recommender algorithm
	...
	/**
	 * The percentage of items in the system which are capable of being recommended 
	 * (i.e. those items which will be ranked by the recsys algorithm).
	...
	/**
	 * The mean of the ratings the item received in the training set.
	 * The relevance of the top-k recommendations made is calculated by 
	 * taking the average of the mean rating over each recommended item. 
	...
	/**
	 * Get the number of common recommendations made by two algorithms
	 * @param alg1
	 * @param alg2
	...
	/**
	 * Evaluate the performance of the recommender algorithm for a single
	 * performance metric across all users in the test set
	 * @param perfunc - the performance metric
	 * @return - the average metric score for all users in the test set
	 */
	...
	/**
	 * Evaluate the performance of the recommender algorithm for multiple 
	 * performance metrics across all users in the test set
	 * @param perfunc - the performance metric
	 * @return - an array of the average metric scores for all users in the test set
	 */
